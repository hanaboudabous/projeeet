...
$listeclient=$LivreurC->afficherlivreurtrier();
          ...
          <div class="form-group">
            <div class="col-md-6">
              ...
              <div class="input-group">
                <input type="text" name="nom" class="form-control" placeholder="nom" maxlength="8" >
              </div>
            </div>
          </div>
        ...
        <div class="form-group">
          ...
          <br>
           <br>
            <div class="form-group">
            <div class="col-md-6">
              <label class="control-label" for="district">Nombre jours de travail</label>
          ...
          <br>
           <br>
            <div class="form-group">
            <div class="col-md-6">
              <label class="control-label" for="district">Télephone</label>
...
foreach($listeEmployes as $row){
  ...
  <td><form method="POST" action="../views/supprimerStock.php">
    <form method="POST" action="triLivreur.php">
