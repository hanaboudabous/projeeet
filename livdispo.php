...
$listeEmployes=$LivraisonC->afficherlivraisontrier();
...
<tbody>
  ...
  <td><a href="../back/modifierLivraison.php?num_livraison=<?PHP echo $row['num_livraison']; ?>">
  Modifier</a></td>
  </tr>

  <?PHP
}?>
<form method="POST" action="livdispo.php">
<input type="submit" name="trier" value="Trier par date de livraison">
</form>
</tbody>
  <!--Table body-->
