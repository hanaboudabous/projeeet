...
$listeEmployes=$LivreurC->afficherlivreurtrier();
...
<div id="wrapper" class="container">
  ...
  <h1>Livreurs</h1> 
    ...
    <form id="form-work" class="" name="f" action="../views/ajoutLivreur.php" method="GET" onsubmit="return verif()">
      ...
      <fieldset>
        ...
        <div class="form-group">
            <div class="col-md-6">
              ...
              <input name="datedenaissance" class="form-control" placeholder="datedenaissance" type="date">
            </div>
          </div>
           <div class="form-group">
            <div class="col-md-6">
 ...
 <option value="conges">conges</option>
  <option value="non conges">non conges</option> 
</select> 
...
foreach($listeEmployes as $row){
  ...
  <td><form method="POST" action="../views/supprimerLivreur.php">
  
  <input type="submit" name="supprimer"  class="btn btn-danger"  value="supprimer">
  <input type="hidden" value="<?PHP echo $row['id']; ?>" name="id">
  </form>
  </td>
  <td><a href="modifierLivreur.php?id=<?PHP echo $row['id']; ?>" style="text-decorations:none; color:white;"  class="btn btn-warning">
  Modifier</a></td>
  </tr>
  <?PHP
}
...
<input type="submit" name="trier" value="Trier par Nombre jours de travail">
</form>
